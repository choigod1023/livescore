      ...
      <Table sx={{ minWidth: 500 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="center">게임차</TableCell>
            <TableCell align="center">연속</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {Data.list &&
            Data.list.map((item, idx) => {
              ...
              return (
                <TableRow key={item.shortNameKo}>
                  ...
                  <TableCell align="center">{item.rank.wpct}</TableCell>
                  <TableCell align="center">{item.rank.gb}</TableCell>
                  <TableCell align="center">{item.rank.streak}</TableCell>
                </TableRow>
              );
            })}
        </TableBody>
